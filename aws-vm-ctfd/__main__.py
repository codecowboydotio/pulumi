...
sudo docker run -p 8080:8000 -d ctfd/ctfd
sudo apt install pipx -y
sudo apt install python3.8-venv -y
sudo pipx install ctfcli
sudo pipx ensurepath
git clone https://github.com/bourkey/ScarletEelChallenges /root/ScarletEelChallenges
"""
