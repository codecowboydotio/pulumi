...
vm_size = config.get("vmSize", "Standard_B4ms")
os_image = config.get("osImage", "Canonical:0001-com-ubuntu-server-jammy:22_04-lts-gen2:latest")
os_image2 = config.get("osImage", "Canonical:0001-com-ubuntu-server-jammy:22_04-lts-gen2:latest")
